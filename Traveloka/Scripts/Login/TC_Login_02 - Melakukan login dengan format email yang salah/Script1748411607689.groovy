...
Mobile.setEncryptedText(findTestObject('Login/Masukkan email atau no. handphone-mu'), 'aRkovEro43qJLpohhV50kKAIwqLTUfpbmjMS4D6+Gq4hvepmaPQhcg==', 
    0)

Mobile.verifyElementVisible(findTestObject('Register/Email atau no. handphone tidak valid'), 0)

Mobile.verifyElementText(findTestObject('Register/Email atau no. handphone tidak valid'), 'Email atau no. handphone tidak valid')
